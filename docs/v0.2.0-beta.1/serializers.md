...
Used to define a custom key when serializing a primary model of type *type*. For example, the default Serializer will return something like the following:
...
related to this model. *type* is the type of the relationship.
