...
Be sure to check out the <DocsLink @route="docs.api.item" @model="modules/serializer~Serializer#keyForAttribute">Serializer</DocsLink> and <DocsLink @route="docs.api.item" @model="modules/serializers/json-api-serializer~JSONAPISerializer">JSONAPISerializer</DocsLink> docs to learn about all the hooks available to customize your serializer layer.
